...
class AccountMove(models.Model):
    ...
    def default_get(self, default_fields):
        ...
        if partner:
            ...
            res["is_1099"] = rep_1099_conf_rec and rep_1099_conf_rec.is_1099 or False
        return res
...
class AccountMoveLine(models.Model):
    ...
    def onchange_partner_1099(self):
        if self.partner_id:
            rep_1099_conf_rec = (
                self.env["report.1099.config.partner"]
                .sudo()
                .search([("partner_id", "=", self.partner_id.id)], limit=1)
            )
            self.is_1099 = rep_1099_conf_rec and rep_1099_conf_rec.is_1099
            if self.partner_id and rep_1099_conf_rec and rep_1099_conf_rec.is_1099:
